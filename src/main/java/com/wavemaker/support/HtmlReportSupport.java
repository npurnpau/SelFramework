...
public class HtmlReportSupport {
	...
	/*public static void createHtmlSummaryReport() throws Exception {
		...
		try {
			...
			writer.write("<title>WaveMaker - Automation Execution Results Summary</title>");
			...
			writer.write("</th>");
			writer.write("<th class = 'Logos' colspan='2' > ");
			writer.write("<img align ='right' src= .//Screenshots//wavemaker.png></img>");
			writer.write("</th> ");
			writer.write("</tr> ");
			...
			writer.write("WaveMaker -  Automation Execution Result Summary ");
			writer.write("</th> ");
			writer.write("</tr> ");
